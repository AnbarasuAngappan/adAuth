...
namespace adAuth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //    {
            //        DirectoryEntry root = new DirectoryEntry(RootPath, "INTELLIBOT\\Sailendra", "utl@123");
            //        DirectorySearcher search = new DirectorySearcher(root);

            //        search.SearchScope = SearchScope.Subtree;
            //        search.Filter = "(sAMAccountName=Sailendra" + ")";
            //        SearchResultCollection results = search.FindAll();

            //        UserPrincipal userP = UserPrincipal.FindByIdentity(ctx, "INTELLIBOT\\Sailendra");
            ...
            #endregion
            var authService = new AdAuthenticationService(AdAuthenticationManager);
        ...
        public ActionResult LogOff()
        {
            ...
            //Ad Auth
            //IAuthenticationManager adauthenticationManager = HttpContext.GetOwinContext().Authentication;
            AdAuthenticationManager.SignOut(MyAuthentication.ApplicationCookie);
            return RedirectToAction("Index", "Home");
        }
        ...
        //AD
        private IAuthenticationManager AdAuthenticationManager
        {
            get
            {
                return HttpContext.GetOwinContext().Authentication;
